...
#
	...
	# also the options for the agents: CPUTime, Occi SumbitPools, Site...
        ...
        do
		su dirac -c"dirac-configure -UHddd -o /LocalSite/SubmitPool=$submitPool -o /LocalSite/CPUTime=$cpuTime -o /LocalSite/Architecture=$platform -o /LocalSite/CloudDriver=$cloudDriver -o /LocalSite/Site=$siteName  -o /LocalSite/VMStopPolicy=$vmStopPolicy  -o /LocalSite/CE=CE-nouse defaults-VMBES.cfg"  >> /var/log/dirac-context-script.log 2>&1
